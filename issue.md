...
Ну я же просил!!! убери дубли! вынеси все в uses / helpers / логика должна быть в компонентах!
Проанализируй и Отрефактори код UI блять!!!

---

Ui - Нужно разбить на переиспользуемые компоненты, и сделать рефактиринг!!!
...
Все эти виджеты, карточки с CPU / Mem и прочее... все это переиспользуемое
