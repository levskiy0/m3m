...
Роут `http://127.0.0.1:3000/api/projects/6931eac04c717825bfe2307c/pipeline/branches`

Возвращает список бранчей С КОДОМ! если кода много это проблема, код для бранча получай по необходимости отдельным методом!

---

Большой баг!!!

новый бранч я назвал `feature/test` и... СУКА! - он стал частью роута!!! 

`http://127.0.0.1:3000/api/projects/6931eac04c717825bfe2307c/pipeline/branches/feature/test`

нужно не название а ID его везде передавать иначе логика ломается
...
В сайдбаре раздели на группы пункты.
