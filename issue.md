...
С созданием файлов и редактированием какая то хуйня... давай так, будем открывать в рамках файлового менеджера вкладку типа с новым или редактируемым файлом
