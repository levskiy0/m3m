...
Менеджер файлов работает всрато!
...
А сейчас у папки нет иконки папки, ничего нельзя выделить, вид GRID вообще не юзабелен, в папку даже провалиться нельзя!

Сделай нормальный менеджер файлов - вот подумай как обычно они выглядят и какие действия есть и сделай!

Вот пример 
- `/Users/dmvsk/Workspace/Projects/telegram-bot-farm/ui/src/components/bot/StorageTab.tsx` 
