...
Тут наверное ты не понял в реализации, должно быть что-то типа pocketbase.
...
runtime api - database должно генерировать схему для Monaco на основании созданных моделей!!!
...
Ты Senior Tester, твоя задача оттестировать систему!
...
Сосредоточься на
- JS тестах
- Тестах того как выполняются непредвиденные ситуации
- Тестах обработки фатальных ошибок
- Удали ненужные и бессмыленные тесты
