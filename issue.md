...
Когда мы переходим в "Global Goals" то уровень проекта скидывается, так не должно быть он же уже выбран (тоже самое Profile)!!!

Profile - убрать из сайдбара как меню а оставить в попапе профиля 
